...
export default function Curriculo() {
    ...
    return (
        <div className="max-w-5xl mx-auto px-4 sm:px-6 md:px-8 lg:px-0 space-y-12 md:space-y-16">
            ...
            >
                ...
                <InfoSection id="resumo" title="Resumo Profissional">
                    <div className="space-y-6 text-sm md:text-base text-gray-800 dark:text-slate-300 leading-relaxed">
                ...
                <InfoSection id="experiencia" title="Experiência Profissional">
                    ...
                    <div className="space-y-8 text-sm md:text-base text-gray-800 dark:text-slate-300 leading-relaxed">
                        ...
                        <div>
                            ...
                            <ul className="mt-6 space-y-3 list-disc list-inside pl-2">
                ...
                <InfoSection id="formacao" title="Formação Acadêmica e Base Técnica">
                    ...
                    <div className="space-y-10 text-sm md:text-base text-gray-800 dark:text-slate-300 leading-relaxed">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                <li>
                                    ...
                                    – UFRRJ, Campus Nova Iguaçu <br />
                                    <em className="text-gray-600 dark:text-slate-400 text-xs md:text-sm">
                                ...
                                <li>
                                    ...
                                    – CIEP 175 – José Lins do Rego (2017)
                                </li>
                            </ul>
                        </div>
